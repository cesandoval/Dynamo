    ...
    public class IronPythonCompletionData : ICompletionData
    {
        ...
        public IronPythonCompletionData(string text, string stub, bool isInstance, CompletionType type, IronPythonCompletionProvider provider)
        {
            ...
            if (IronPythonCompletionData.TypeToIcon == null)
            {
                ...
                bi.BeginInit();
                bi.StreamSource = assembly.GetManifestResourceStream(@"DynamoDecodes.Resources.method.png");
                bi.EndInit();
                ...
                b2.BeginInit();
                b2.StreamSource = assembly.GetManifestResourceStream(@"DynamoDecodes.Resources.namespace.png");
                b2.EndInit();
                ...
                b3.BeginInit();
                b3.StreamSource = assembly.GetManifestResourceStream(@"DynamoDecodes.Resources.field.png");
                b3.EndInit();
                ...
                b4.BeginInit();
                b4.StreamSource = assembly.GetManifestResourceStream(@"DynamoDecodes.Resources.class.png");
                b4.EndInit();
                ...
                b5.BeginInit();
                b5.StreamSource = assembly.GetManifestResourceStream(@"DynamoDecodes.Resources.property.png");
                b5.EndInit();
                ...
                b6.BeginInit();
                b6.StreamSource = assembly.GetManifestResourceStream(@"DynamoDecodes.Resources.property.png");
                b6.EndInit();
